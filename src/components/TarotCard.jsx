...
function TarotCard({ card, onSelect }) {
  ...
  return (
    ...
    >
      <div
        className={`flex-1 flex items-center justify-center overflow-hidden relative ${locked ? 'bg-cover bg-center' : 'bg-linear-to-br from-indigo-900 to-[#0B0A14]'
          }`}
        style={locked ? { backgroundImage: "url('/manage-deck-bg.jpg')" } : undefined}
      >
